...
public class ModelsAndViewsController {
    ...
    private class ToProbDistAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            String newContent = "";
            for (CharProbability p : CryptoAnalysis.charProbabilitiesOf(theBackendModel.theTextFile.fileContent)) {
                newContent += p + "\n";
            }
    ...
    private class ToSortedProbDistAction implements ActionListener {
    ...
    private void initController() {
        ...
        this.theMainViewDisplay.toProbDist.addActionListener(new ToProbDistAction());
        this.theMainViewDisplay.toSortedProbDist.addActionListener(new ToSortedProbDistAction());
        this.theMainViewDisplay.approxDecryptButton.addActionListener(new ApproxDecryptAction());
    }
}
